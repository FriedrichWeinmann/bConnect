Function New-bConnectDynamicGroup() {
	...
	Param (
		...
		[string]$Name,
		[string]$ParentGuid = "BDE918DC-89C0-458A-92F7-0BB9147A2706",
		#guid of "Dynamic Groups" as fallback
	...
	If ($_connectVersion -ge "1.0") {
		...
		return Invoke-bConnectPost -Controller "DynamicGroups" -Data $_body
	}
	else {
		return $false
	}
